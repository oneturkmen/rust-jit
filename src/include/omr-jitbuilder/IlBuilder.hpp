...
class IlBuilder {
    ...
    public: void TableSwitch(const char * selectionVar, IlBuilder ** defaultBuilder, bool generateBoundsCheck, int32_t numCases, IlBuilder::JBCase ** cases);
    public: void TableSwitch(const char * selectionVar, IlBuilder ** defaultBuilder, bool generateBoundsCheck, int32_t numCases, ...);
